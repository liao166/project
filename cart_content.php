...
<?php if ($cart_rs->rowCount() != 0) { ?>
    ...
    <a href="checkout.php" id="btn04" name="btn04" class="btn btn-mycolor">前往結帳</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control" id="qty[]" name="qty[]" value="<?php echo $cart_data['qty']; ?>" min="1" max="50" cartid="<?php echo $cart_data['cartid']; ?>" required>
                            </div>
                        </td>
                        <td>
